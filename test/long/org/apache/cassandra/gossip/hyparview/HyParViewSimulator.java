...
public class HyParViewSimulator
{
    ...
    private PennStationDispatcher dispatcher;
    ...
    public static void assertCluster(PennStationDispatcher dispatcher)
    {
        while (true)
        {
            ...
            {
                // nop - just retry the operation after waiting for acquiesce, again
                dispatcher.awaitQuiesence();
            }
        }
    }
    ...
    private static InetAddress generateAddr(int dc, int node) throws UnknownHostException
    {
