...
public class InboundHandshakeHandlerTest
{
    ...
    public void setupPipeline_NoCompression()
    {
        ...
        handler.setupMessagingPipeline(pipeline, InboundHandshakeHandler.createHandlers(addr.getAddress(), false, MESSAGING_VERSION, NOP_CONSUMER));
    ...
    public void setupPipeline_WithCompression()
    {
        ...
        handler.setupMessagingPipeline(pipeline, InboundHandshakeHandler.createHandlers(addr.getAddress(), true, MESSAGING_VERSION, NOP_CONSUMER));
        Assert.assertNotNull(pipeline.get(MessageReceiveHandler.class));
