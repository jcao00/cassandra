...
public class FailureDetector implements IFailureDetector, FailureDetectorMBean
{
    ...
    //TODO - gossipocolypse
    public static final IFailureDetector instance = new FailureDetector(null, true);
    ...
    public FailureDetector(Gossiper gossiper, boolean registerJmx)
    {
    ...
    {
        Map<String, String> nodesStatus = new HashMap<>(gossiper.endpointStateMap.size());
        for (Map.Entry<InetAddress, EndpointState> entry : gossiper.endpointStateMap.entrySet())
        {
