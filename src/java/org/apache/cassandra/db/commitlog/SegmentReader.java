...
public class SegmentReader implements Iterable<SegmentReader.SyncSegment>
{
    ...
    protected SegmentReader(CommitLogDescriptor descriptor, RandomAccessReader reader, boolean tolerateErrors)
    {
    ...
    public static class SyncSegment
    {
        ...
        public SyncSegment(FileDataInput input, int fileStartPosition, int fileEndPosition, int endPosition)
        {
            this.input = input;
    ...
    static class CompressedSegmenter implements Segmenter
    {
        ...
        public SyncSegment nextSegment(final int startPosition, final int nextSectionStartPosition) throws IOException
        {
            ...
            return new SyncSegment(input, startPosition, nextSectionStartPosition, (int)nextLogicalStart);
        }
    }
