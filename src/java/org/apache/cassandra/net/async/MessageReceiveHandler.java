...
{
    public static final Logger logger = LoggerFactory.getLogger(MessageReceiveHandler.class);
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception
    {
        ...
        switch (state)
        {
            ...
            case READ_PAYLOAD:
                ...
                {
                    // TODO consider deserailizing the messge not on the IO thread (but then on which thread?)
