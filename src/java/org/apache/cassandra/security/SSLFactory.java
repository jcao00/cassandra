...
public final class SSLFactory
{
    ...
    {
        try (RandomAccessReader tsf = RandomAccessReader.open(new File(options.truststore)))
        {
    ...
    {
        try (RandomAccessReader ksf = RandomAccessReader.open(new File(options.keystore)))
        {
