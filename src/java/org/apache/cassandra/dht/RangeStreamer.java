...
public class RangeStreamer
{
    ...
    {
        return getRangeFetchMap(rangesWithSourceTarget, Collections.<ISourceFilter>singleton(new FailureDetectorSourceFilter(StorageService.instance.peerStatusService.fd)));
    }
