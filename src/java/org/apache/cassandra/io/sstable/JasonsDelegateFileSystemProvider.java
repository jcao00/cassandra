 ...
 */
public class JasonsDelegateFileSystemProvider extends FileSystemProvider
{
    private static final Logger logger = LoggerFactory.getLogger(JasonsDelegateFileSystemProvider.class);
    private final FileSystemProvider delegate;

    public JasonsDelegateFileSystemProvider()
    {
        logger.info("nop ctor");
        delegate = null;
    }

    public JasonsDelegateFileSystemProvider(FileSystemProvider delegate)
    {
    ...
    public FileSystem getFileSystem(URI uri)
    {
        try
        {
            return new JasonsDelegateFileSystem(this, delegate.getFileSystem(uri));
        }
        catch (Exception e)
        {
    ...
    {
        return new JasonsAsyncFileChannel(path, options);
    }
