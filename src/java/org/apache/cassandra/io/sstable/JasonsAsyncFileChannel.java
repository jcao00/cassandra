...
//        }
    ...
    protected native ByteBuffer init(Class controllerClass, String fileName, int maxIO, Object logger) throws JasonsAsyncException;
     ...
     */
    protected native void read(Object thisObject, ByteBuffer handle, long position, long size, ByteBuffer buffer, Object aioPackageCallback) throws JasonsAsyncException;
