...
public class NodeProbe implements AutoCloseable
{
    ...
    /**
     * Creates a NodeProbe using the specified JMX host, port, username, password, and possibly connects over SSL.
     *
    ...
    /**
     * Creates a NodeProbe using the specified JMX host, port, and possibly connects over SSL.
     *
     * @param host hostname or IP address of the JMX agent
     * @param port TCP port of the remote JMX agent
     * @param sslEnabled Use SSL when connecting to the JMX agent
    ...
    /**
     * Creates a NodeProbe using the specified JMX host, default port, and possibly connects over SSL.
     *
     * @param host hostname or IP address of the JMX agent
     * @param sslEnabled Use SSL when connecting to the JMX agent
     * @throws IOException on connection failures
