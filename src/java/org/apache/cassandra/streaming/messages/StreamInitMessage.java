...
public class StreamInitMessage extends StreamMessage
{
    ...
    public StreamInitMessage(InetAddress from, int sessionIndex, UUID planId, String description, boolean keepSSTableLevel, boolean isIncremental)
    {
    ...
    private static class StreamInitMessageSerializer implements IVersionedSerializer<StreamInitMessage>
    {
        ...
        public StreamInitMessage deserialize(DataInputPlus in, int version) throws IOException
        {
            ...
            return new StreamInitMessage(from, header.right, header.left, description, keepSSTableLevel, isIncremental);
        }
