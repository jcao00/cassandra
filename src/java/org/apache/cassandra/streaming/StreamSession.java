...
public class StreamSession implements IEndpointStateChangeSubscriber
{
    ...
    public final InetAddressAndPort preferredPeerInetAddressAndPort;
    ...
    public StreamSession(StreamOperation streamOperation, InetAddressAndPort peer, StreamConnectionFactory factory, int index, UUID pendingRepair, PreviewKind previewKind)
    {
        ...
        final InetAddressAndPort preferredPeerEndpoint = MessagingService.instance().getPreferredRemoteAddr(peer);
        preferredPeerInetAddressAndPort = (preferredPeerEndpoint == null) ? peer : preferredPeerEndpoint;
