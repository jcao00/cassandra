...
public class PrepareMessage extends RepairMessage
{
    ...
    public PrepareMessage(UUID parentRepairSession, List<UUID> cfIds, Collection<Range<Token>> ranges, boolean incrementalRepair)
    {
    ...
    public static class PrepareMessageSerializer implements MessageSerializer<PrepareMessage>
    {
        public void serialize(PrepareMessage message, DataOutputPlus out, int version) throws IOException
        {
            ...
            out.writeBoolean(message.incrementalRepair);
        }
        ...
        public PrepareMessage deserialize(DataInput in, int version) throws IOException
        {
            ...
            boolean incrementalRepair = in.readBoolean();
            return new PrepareMessage(parentRepairSession, cfIds, ranges, incrementalRepair);
        }
        ...
        public long serializedSize(PrepareMessage message, int version)
        {
            ...
            size += sizes.sizeof(message.incrementalRepair);
            return size;
        }
    }
    ...
    public String toString()
    {
        return "PrepareMessage{" +
                ...
                ", is_incremental_repair=" + incrementalRepair +
                '}';
    }
}
